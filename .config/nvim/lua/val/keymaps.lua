...
vim.keymap.set("n", "<leader>r", ":edit<CR>", { noremap = true, silent = true, desc = "reload buffer" })
...
-- Define key mapping to close current buffer
vim.keymap.set("n", "<leader>bk", ":bd!<CR>", { noremap = true, silent = true, desc = "buffer kill" })

-- Replace case insensitive the word under the cursor in the whole buffer
vim.keymap.set("n", "<leader>S", [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/g<Left><Left><Left>]], { desc = "substitute string" })
