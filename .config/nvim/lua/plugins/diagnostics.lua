return {
	...
	config = function()
		...
		vim.api.nvim_set_hl(0, "TinyInlineDiagnosticVirtualTextError", { link = "DiagnosticError" })
		vim.api.nvim_set_hl(0, "TinyInlineDiagnosticVirtualTextWarn", { link = "DiagnosticWarn" })
		vim.api.nvim_set_hl(0, "TinyInlineDiagnosticVirtualTextInfo", { link = "DiagnosticInfo" })
		vim.api.nvim_set_hl(0, "TinyInlineDiagnosticVirtualTextHint", { link = "DiagnosticHint" })
		vim.api.nvim_set_hl(0, "TinyInlineInvDiagnosticVirtualTextError", { link = "DiagnosticError" })
